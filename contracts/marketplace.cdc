...
pub contract Marketplace {
    ...
    // Event that is emitted when a seller withdraws their token from the sale
    ...
    pub resource SaleCollection: SalePublic {
        ...
        // Dictionary of prices for each NFT by ID
        pub var prices: {UInt64: UFix64}

        // The fungible token vault of the owner of this sale.
        // When someone buys a token, this resource can deposit
        // tokens into thier account.
        ...
        pub fun purchase(
            ...
            // remove the token price from the prices array
            self.prices[tokenID] = nil

            // deposit the purchasing tokens into the owner's vault
        ...
        // getIDs returns an array of all token IDs that are for sale
        pub fun getIDs(): [UInt64] {
